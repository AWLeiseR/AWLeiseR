# Hi there, I'm Alan (AWLeiseR) 👋

I'm a passionate **Full Stack Developer** from Brazil, with a strong interest in **IoT** and **Artificial Intelligence**.
I love building scalable web applications and exploring new technologies.

- 🔭 I’m currently working on **Full Stack Web Development** (Event Horizon, BookNoteBot).
- 🌱 I’m currently refining my skills in **NestJS**, **Next.js**, and **TypeScript**.
- 💬 Ask me about **React, Prisma, and Backend Architecture**.
...
![Next JS](https://img.shields.io/badge/Next-black?style=for-the-badge&logo=next.svg&logoColor=white)
